...
$Pathurl = "https://api.jpn.cloud.watchguard.com/rest/endpoint-security/management/api/v1/accounts/WGC-3-981e96282dcc4ad0856c/devices?$`count=true"
$Pathheaders = @{
    "accept" = "application/json"
...
$response = Invoke-RestMethod -Uri $Pathurl -Method Get -Headers $Pathheaders
